...
related: [testing-quality-minimum-case-set, testing-quality-behavior-not-implementation, testing-mocking-what-to-mock, testing-async-async-testing, testing-quality-document-verification-gates]
---
...
| The thing under check is a document, not code (spec/RFC/schema doc gated by grep) | Same red-run rule, different mutation axes (structure, modality, polarity, enum completeness) → [testing-quality-document-verification-gates] |
